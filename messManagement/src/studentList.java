...
//            sql="SELECT Name,RegNo FROM STUDENTS";
//            ResultSet rs= stmt.executeQuery(sql);
//            while(rs.next()){
//                String reg=rs.getString("RegNo");
//                String nm=rs.getString("Name");
//                list.addElement("           "+reg+"                 " + nm);
//            }
//        }catch (Exception e){
//            e.printStackTrace();
//        }
...
//                try {
//                    sql="SELECT Name,RegNo FROM STUDENTS WHERE Name = '"+str+"' OR RegNo = '"+str+"'";
//                    ResultSet rs= stmt.executeQuery(sql);
//                    while(rs.next()){
//                        String reg=rs.getString("RegNo");
//                        String nm=rs.getString("Name");
//                        tp.addElement("           "+reg+"                 " + nm);
//                    }
...
//                    cancelListener();
                ...
                frame.setVisible(true);
//                try {
//                    sql = "DELETE FROM STUDENTS WHERE RegNo= " + reg;
//                    stmt.executeUpdate(sql);
//                    sql = "DELETE FROM SLOT_DETAILS WHERE RegNo= " + reg;
//                    stmt.executeUpdate(sql);
//
//                }catch (Exception ex){
//                    ex.printStackTrace();
...
//        sql="SELECT Name,Hostel,Room_no,Mobile_no,Email,Password FROM STUDENTS WHERE RegNo= "+reg;
//        ResultSet rs= null;
//        try {
//            rs = stmt.executeQuery(sql);
//            while (rs.next()){
//                String nm1=rs.getString("Name");
//                String nm2=rs.getString("Hostel");
//                String nm3=rs.getString("Room_no");
//                String nm4=rs.getString("Mobile_no");
//                String nm5=rs.getString("Email");
//                String nm6=rs.getString("Password");
//
//                l1.setText("Name: "+nm1);
//                l3.setText("Hostel: "+nm2);
//                l4.setText("Room No.: "+nm3);
//                l5.setText("Mobile No.: "+nm4);
//                l6.setText("Email: "+nm5);
//                l7.setText("Password: nm6");
//
//            }
